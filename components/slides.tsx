    ...
    <Card className="mx-auto w-full max-w-xl">
      ...
      <div className="mt-6 space-y-4 text-ink-soft">
        <p>
          ...
          people exactly like you: driven professionals — men and women — who
          take their work seriously and want to take their health just as
          seriously, without turning their life upside down to do it.
        </p>
        <p>
        ...
        <p>
          ...
          stronger, sharper, more energized version of yourself — on a plan you
